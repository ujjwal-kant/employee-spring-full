...
public class ProductDtoTest extends AbstractUnitTest {
    ...
    @Test
    public void testSadAddProductIfBarcodeIsEmpty() throws ApiException{
        BrandForm brandForm = new BrandForm();
        brandForm.setBrand("Nike");
        brandForm.setCategory("  spOrt");
    ...
    @Test
    public void testSadAddProductIfBrandIsEmpty() throws ApiException{
        try{
            ProductForm productForm=new ProductForm();
    ...
    @Test
    public void testSadAddProductIfCategoryIsEmpty() throws ApiException{
        try{
            ProductForm productForm=new ProductForm();
            productForm.setBarcode("pol");
    ...
    @Test
    public void testSadAddProductIfMrpIsNeagtive() throws ApiException{
        try{
            ProductForm productForm=new ProductForm();
            productForm.setBarcode("pol");
            productForm.setBrand("gkkkt");
    ...
    @Test
    public void testSadAddProductIfNameIsEmpty() throws ApiException{
        try{
            ProductForm productForm=new ProductForm();
            productForm.setBarcode("pol");
            productForm.setBrand("gkkkt");
    ...
    @Test
    public void testSadAddProductIfBrandCtageoryNotExists() throws ApiException{
        try{
            ProductForm productForm=new ProductForm();
            productForm.setBarcode("pol");
            productForm.setBrand("gkkkt");
    ...
    @Test
    public void testSadAddProductIfBarcodeNotUnique() throws ApiException{
        BrandForm brandForm = new BrandForm();
        brandForm.setBrand("Nike");
        brandForm.setCategory("  spOrt");
    ...
    public void testHappyUpdateProduct() throws ApiException{
        ...
        ProductData productData = productDto.update(id,productUpdateForm);

        assertEquals(productUpdateForm.getBarcode(), productData.getBarcode());
        assertEquals(productUpdateForm.getMrp(), productData.getMrp());
        assertEquals(productUpdateForm.getName(), productData.getName());
    }
