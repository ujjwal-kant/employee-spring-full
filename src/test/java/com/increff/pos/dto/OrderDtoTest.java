...
public class OrderDtoTest extends AbstractUnitTest{
    ...
    @Test
    public void testSadAddOrderItemNotEmpty() throws ApiException{
    ...
    @Test
    public void testSadAddOrderQuantityNotLessThanZero() throws ApiException{
        try{   
            List<String> barcodes = new ArrayList<String>();
            List<Integer>quantities = new ArrayList<Integer>();
            List<Double>sellingPrices = new ArrayList<Double>();
    ...
    @Test
    public void testSadAddOrderSellingPriceNotLessThanZero() throws ApiException{
        try{    
            List<String> barcodes = new ArrayList<String>();
            List<Integer>quantities = new ArrayList<Integer>();
            List<Double>sellingPrices = new ArrayList<Double>();
    ...
    @Test
    public void testSadAddOrderItemCannotConatinsMultipleInstance() throws ApiException{
        try{
            List<String> barcodes = new ArrayList<String>();
            List<Integer>quantities = new ArrayList<Integer>();
            List<Double>sellingPrices = new ArrayList<Double>();
    ...
    @Test
    public void testSadAddOrdersellingPriceLessThanMrp() throws ApiException{
        try{
            List<String> barcodes = new ArrayList<String>();
            List<Integer>quantities = new ArrayList<Integer>();
            List<Double>sellingPrices = new ArrayList<Double>();
